    ...
    <div class="flex-1 flex flex-col gap-6 w-full max-w-7xl mx-auto py-6">
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-xl border border-neutral-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 p-6 shadow-sm text-center hover:border-emerald-300 dark:hover:border-violet-600 transition-colors">
                <div class="w-20 h-20 mx-auto bg-emerald-100 dark:bg-violet-950/30 text-emerald-600 dark:text-violet-400 rounded-full flex items-center justify-center text-2xl font-bold mb-4">
                    EC
                </div>
